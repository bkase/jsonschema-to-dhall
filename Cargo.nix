...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "jsonschema-to-dhall" = rec {
        crateName = "jsonschema-to-dhall";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "jsonschema-to-dhall"; path = "src/main.rs"; }
        ];
      ...
      "schemars" = rec {
        ...
        version = "0.7.2";
        edition = "2018";
        sha256 = "1hsvcn71sigmz34l3p3632jd0x6x9j5fv06bjv5xciq049y28rlg";
        authors = [
      ...
      "schemars_derive" = rec {
        ...
        version = "0.7.2";
        edition = "2018";
        sha256 = "1w4myhkkj6h1frghiphn9s1gdvn41z80hh693kzx8f34556xmasj";
        procMacro = true;
        authors = [
          "Graham Esau <gesau@hotmail.co.uk>"
        ];
